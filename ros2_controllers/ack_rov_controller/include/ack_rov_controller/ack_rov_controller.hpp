...
#ifndef ACK_ROV_CONTROLLER__ACK_ROV_CONTROLLER_HPP_
#define ACK_ROV_CONTROLLER__ACK_ROV_CONTROLLER_HPP_
...
#include "ack_rov_controller/odometry.hpp"
#include "ack_rov_controller/speed_limiter.hpp"
#include "ack_rov_controller/visibility_control.h"
...
class AckRovController : public controller_interface::ControllerInterface
{
  using Twist = geometry_msgs::msg::TwistStamped;

public:
  ACK_ROV_CONTROLLER_PUBLIC
  AckRovController();
...
protected:
  ...
  const char * feedback_type_steer() const;                                                    
  CallbackReturn configure_side_steer(                                                          
...
#endif  // ACK_ROV_CONTROLLER__ACK_ROV_CONTROLLER_HPP_
